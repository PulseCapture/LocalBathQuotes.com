  ...
  return (
    <div className="min-h-screen flex justify-center items-start pt-0 p-6 bg-gray-120">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-3xl w-full">
        ...
        <p className="text-lg text-gray-600 text-center mb-6">Last updated: February 03, 2025</p>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Interpretation and Definitions</h2>
        <h3 className="text-xl font-semibold text-gray-800 mt-4">Interpretation</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        
        <h3 className="text-xl font-semibold text-gray-800 mt-4">Definitions</h3>
        <ul className="list-disc pl-6 my-4 text-gray-700">
          ...
          <li>
            <strong>Website</strong> refers to Bath Flipper LLC, accessible from <a href="https://www.bathflipper.com" className="text-blue-500 hover:underline">https://www.bathflipper.com</a>
          </li>
          <li>
            <strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
          </li>
        </ul>        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Collecting and Using Your Personal Data</h2>
        <h3 className="text-xl font-semibold text-gray-800 mt-4">Types of Data Collected</h3>
        <h4 className="text-lg font-semibold text-gray-800 mt-4">Personal Data</h4>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h4 className="text-lg font-semibold text-gray-800 mt-4">Usage Data</h4>
        ...
        <h4 className="text-lg font-semibold text-gray-800 mt-4">Information from Third-Party Social Media Services</h4>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h4 className="text-lg font-semibold text-gray-800 mt-4">Tracking Technologies and Cookies</h4>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <ul className="list-disc pl-6 my-4 text-gray-700">
          ...
          <li>
	        ...
	        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Use of Your Personal Data</h2>
        <ul className="list-disc pl-6 my-4 text-gray-700">
          <li>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Retention of Your Personal Data</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Transfer of Your Personal Data</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Disclosure of Your Personal Data</h2>
        <h3 className="text-xl font-semibold text-gray-800 mt-4">Business Transactions</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
          If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
        </p>

        <h3 className="text-xl font-semibold text-gray-800 mt-4">Law enforcement</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
          Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g., a court or a government agency).
        </p>

        <h3 className="text-xl font-semibold text-gray-800 mt-4">Other legal requirements</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Security of Your Personal Data</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
        </p>

        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Children's Privacy</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Links to Other Websites</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <ul className="list-disc pl-6 my-4 text-gray-700">
          <li>By email: support@LocalBathQuotes.com</li>
          <li>By mail: 113 Cherry St, Seattle, Washington, United States</li>
