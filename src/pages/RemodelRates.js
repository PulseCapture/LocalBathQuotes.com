  ...
  return (
     <div className="min-h-screen flex justify-center items-start pt-16 p-6">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-3xl w-full">
        ...
        <ul className="list-disc pl-6 my-4 text-gray-700">
          <li><strong>Labor:</strong> Labor is often the most expensive part of the remodel, accounting for <strong>40%–65%</strong> of the total cost. The complexity of the work will significantly influence this.</li>
          <li><strong>Materials:</strong> Tile, fixtures, and cabinetry can vary widely in price. High-quality stone tiles and custom vanities can drive the cost up.</li>
          <li><strong>Plumbing & Electrical:</strong> If you're moving plumbing fixtures or adding new lighting, expect to pay more for professional work in these areas.</li>
        </ul>

        <h2 className="text-2xl font-semibold text-gray-800 mt-6">What You Get for the Money</h2>
        <ul className="list-disc pl-6 my-4 text-gray-700">
          <li><strong>Low-End Remodel:</strong> Refreshing existing features, replacing an old vanity with a new one, retiling the shower or floor with basic tiles, and updating fixtures.</li>
          <li><strong>Mid-Range Remodel:</strong> Replacing everything, from the vanity and countertops to the tub or shower, plus mid-range tiles and new lighting fixtures.</li>
          <li><strong>Luxury Remodel:</strong> A complete overhaul with custom cabinetry, high-end materials like marble, underfloor heating, and custom showers or soaking tubs.</li>
        </ul>

        <h2 className="text-2xl font-semibold text-gray-800 mt-6">Considerations for Your Budget</h2>
        <ul className="list-disc pl-6 my-4 text-gray-700">
          <li><strong>Size of the Bathroom:</strong> Naturally, larger bathrooms will cost more to remodel than smaller ones.</li>
          <li><strong>Quality of Materials:</strong> The price can significantly increase if you choose premium materials like natural stone or custom finishes.</li>
          <li><strong>Customization:</strong> Custom-built elements (vanities, cabinets, etc.) will always add to the cost compared to pre-fabricated options.</li>
          <li><strong>Hidden Costs:</strong> Older homes may come with surprises, like water damage or outdated wiring, that can increase the overall price.</li>
        </ul>
