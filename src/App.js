...
import ScrollToTop from "./components/ScrollToTop"; // ✅ Ensures Scroll-To-Top works globally
...
`,
  ...
  return (
    <div>
      <ScrollToTop /> {/* ✅ Scroll-To-Top now applies globally */}
      ...
      >
        ...
        <div className="hidden md:flex space-x-8 items-center">
          ...
          <Link to="/contact-us" className="text-white hover:text-gray-300 text-lg">Contact Us</Link>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="absolute top-16 left-0 w-full bg-[#89B8F6]/90 shadow-lg z-50 flex flex-col items-center space-y-4 py-6 transition-all duration-300 border-t border-white">
